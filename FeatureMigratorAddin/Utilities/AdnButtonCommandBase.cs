...
namespace FeatureMigratorAddin.Utilities
{
    abstract public class AdnButtonCommandBase : AdnCommand
    {
        ...
        protected Icon StandardIcon
        {
            get
            {
                try
                {
                    if ((_standardIcon == null) && (string.IsNullOrEmpty(IconName) == false))
                    {
                        _standardIcon = GetIcon(IconName, new Size(16, 16));
                    }
        ...
        protected Icon LargeIcon
        {
            get
            {
                try
                {
                    if ((_largeIcon == null) && (string.IsNullOrEmpty(IconName) == false))
                    {
                        _largeIcon = GetIcon(IconName, new Size(32, 32));
                    }
                    return _largeIcon;
                }
                catch
